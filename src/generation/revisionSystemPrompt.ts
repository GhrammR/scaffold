...
4. Never include markdown syntax (no #, *, -, backticks) in any field — plain text only. The app renders formatting.
5. You MUST report through the generate_scaffold tool. Do not respond with plain text.`
}
